...
describe('#1036 — normalizeDelegateArgs', () => {
    ...
    it('usa o conjunto padrão de LEITURA quando tools é omitido', () => {
        ...
        expect(r.tools).toEqual(['search', 'list_products', 'search_customer', 'get_customer_details', 'web_search']);
    });
...
describe('#1036 — conjunto padrão NÃO contém tools destrutivas', () => {
    ...
    it('o conjunto padrão é exatamente os 5 de leitura (nomes canônicos do dispatcher)', () => {
