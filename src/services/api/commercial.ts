...
// Mapeia uma linha de proposta origem para o payload de criação da cópia.
...
export const mapProposalLineForClone = (l: Record<string, any>): Record<string, unknown> => ({
