...
import { Bug, Sparkles, Shield, Wrench, TestTube, GitMerge, Loader2, Eye, CheckCircle, XCircle, RotateCcw, MessageSquare, Trash2, Pencil, Terminal, ExternalLink, Search, Tag, CircleDot, Clock, Star, Play, RefreshCw, ShieldOff, Plus, Filter, LayoutGrid, List, GripVertical } from 'lucide-react';
import { toast } from 'sonner';
import { useDolibarr } from '../../context/DolibarrContext';
import { useConfirm } from '../../hooks/useConfirm';
import DiffViewer from '../TasksBoard/DiffViewer';
import TaskConsole from '../TasksBoard/TaskConsole';
// #1179: TaskHistoryModal e os helpers de UI de status foram extraídos para arquivos próprios
// (STATUS_CONFIG/formatOutcomeTime em taskStatusUi) — permite testar o modal de forma ISOLADA,
// sem montar a página inteira (critério de aceite #4: "componente do modal com fetch mockado").
