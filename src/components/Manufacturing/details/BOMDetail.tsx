...
import { getTabClasses, getThemeClasses } from '../../../utils/theme';
        ...
        <div className="flex flex-col h-full bg-white dark:bg-slate-900 border-l border-slate-200 dark:border-slate-800">
            ...
            <div className="flex-none bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-100 dark:border-slate-800 p-4 flex items-center justify-between z-10">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button className={`flex items-center gap-1 text-xs ${theme.badge} px-3 py-1 rounded font-bold`}>
                        <Hammer size={12} /> V{1}
                    </button>
                    ...
                    {bomDetailTab === 'overview' && (
                        <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
                            <div className="flex items-start gap-6">
                                <div className={`p-4 ${theme.bg100} ${theme.bgDark900} ${theme.text600} rounded-xl`}>
                                    <Layers size={32} />
                                </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
                                <h3 className="font-bold text-slate-800 dark:text-white mb-6 flex items-center gap-2">
                                    <Layers size={18} className={theme.text500} /> Árvore de Estrutura
                                </h3>

                                <div className="relative pl-4 border-l-2 border-slate-200 dark:border-slate-700 space-y-6">
                                    {/* Parent Node */}
                                    <div className="relative">
                                        <div className={`absolute -left-[25px] top-3 w-4 h-4 rounded-full ${theme.bg500} border-4 border-white dark:border-slate-900`}></div>
                                        <div className={`border ${theme.activeCard} p-3 rounded-lg inline-block min-w-[200px]`}>
                                            <div className={`text-xs font-bold ${theme.text700} uppercase`}>Produto Final</div>
