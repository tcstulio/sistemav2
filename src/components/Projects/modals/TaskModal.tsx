...
export const TaskModal: React.FC<TaskModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div data-testid="task-modal" className="bg-white dark:bg-slate-900 rounded-xl shadow-2xl w-full max-w-md border border-slate-200 dark:border-slate-800">
                ...
                <form onSubmit={onSubmit} className="p-4 space-y-4">
                    ...
                    <div className="pt-2 flex justify-end gap-2">
                        ...
                        <button data-testid="task-submit-button" type="submit" disabled={isSubmitting} className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors disabled:opacity-50">
