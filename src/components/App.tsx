...
const ApprovalDashboard = React.lazy(() => import('./Banking/ApprovalDashboard'));
            ...
            <BrowserRouter>
                ...
                <Routes>
                    <Route element={<MainLayout />}>
                        ...
                        <Route path="/orders/new" element={<ViewWrapper Component={OrderList} viewId="orders" />} />
                        <Route path="/orders/:id" element={<ViewWrapper Component={OrderList} viewId="orders" />} />
                        <Route path="/orders/:id/edit" element={<ViewWrapper Component={OrderList} viewId="orders" />} />
                        ...
                        <Route path="/interventions/:id" element={<ViewWrapper Component={InterventionList} viewId="interventions" />} />
                        <Route path="/interventions/:id/edit" element={<ViewWrapper Component={InterventionList} viewId="interventions" />} />
                        ...
                        <Route path="/hr/candidates/new" element={<ViewWrapper Component={HRList} viewId="hr" />} />
                        <Route path="/hr/candidates/:id/edit" element={<ViewWrapper Component={HRList} viewId="hr" />} />
                        <Route path="/hr/users/new" element={<ViewWrapper Component={HRList} viewId="hr" />} />
                        <Route path="/hr/users/:id/edit" element={<ViewWrapper Component={HRList} viewId="hr" />} />
                        <Route path="/hr/groups/new" element={<ViewWrapper Component={HRList} viewId="hr" />} />
                        <Route path="/hr/groups/:id/edit" element={<ViewWrapper Component={HRList} viewId="hr" />} />
                        <Route path="/hr/expenses/new" element={<ViewWrapper Component={HRList} viewId="hr" />} />
                        <Route path="/hr/expenses/:id/edit" element={<ViewWrapper Component={HRList} viewId="hr" />} />
                        ...
                        <Route path="/agenda/new" element={<ViewWrapper Component={AgendaView} viewId="agenda" />} />
                        <Route path="/agenda/:id/edit" element={<ViewWrapper Component={AgendaView} viewId="agenda" />} />
                        ...
                        <Route path="/approvals" element={<ViewWrapper Component={ApprovalDashboard} viewId="approvals" />} />
