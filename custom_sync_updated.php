...
switch ($type) {
    ...
    case 'events':
        ...
        $sql = "SELECT id as id, ref, label, note as description, code as type_code, UNIX_TIMESTAMP(datep) as date_start, UNIX_TIMESTAMP(datep2) as date_end, percent as percentage, fk_user_author, fk_soc as socid, fk_project as project_id, location, elementtype, fk_element, fulldayevent, priority, transparency, UNIX_TIMESTAMP(datec) as datec, UNIX_TIMESTAMP(tms) as tms";
    ...
    case 'tasks':
        ...
        $sql = "SELECT rowid as id, ref, label, description, UNIX_TIMESTAMP(dateo) as date_start, UNIX_TIMESTAMP(datee) as date_end, progress, fk_user_valid as fk_user_assign, fk_user_creat, fk_task_parent as fk_parent, fk_projet as project_id, UNIX_TIMESTAMP(datec) as datec, UNIX_TIMESTAMP(tms) as tms";
    ...
    case 'supplier_orders':
        $sql = "SELECT rowid as id, ref, fk_soc, fk_projet as project_id, UNIX_TIMESTAMP(date_creation) as date_creation, UNIX_TIMESTAMP(date_livraison) as date_livraison, total_ttc, fk_statut as statut, UNIX_TIMESTAMP(tms) as tms";
    ...
    case 'supplier_invoices':
        $sql = "SELECT rowid as id, ref, fk_soc, fk_projet as project_id, UNIX_TIMESTAMP(datef) as date_invoice, total_ttc, fk_statut as statut, paye, UNIX_TIMESTAMP(datec) as datec, UNIX_TIMESTAMP(tms) as tms";
    ...
    case 'shipments':
        $sql = "SELECT rowid as id, ref, fk_soc, fk_projet as project_id, UNIX_TIMESTAMP(date_creation) as date_creation, UNIX_TIMESTAMP(date_expedition) as date_delivery, fk_statut as status, tracking_number, UNIX_TIMESTAMP(tms) as tms";
    ...
    case 'expense_reports':
        ...
        $sql = "SELECT rowid as id, ref, total_ttc, NULL as project_id, UNIX_TIMESTAMP(date_debut) as date_debut, UNIX_TIMESTAMP(date_fin) as date_fin, fk_statut as statut, fk_user_author, UNIX_TIMESTAMP(tms) as tms";
    ...
    case 'leave_requests':
        // Fixed: Added fk_type (leave type ID), ref
        $sql = "SELECT rowid as id, ref, fk_type as type, halfday, UNIX_TIMESTAMP(date_debut) as date_debut, UNIX_TIMESTAMP(date_fin) as date_fin, description, fk_user, statut, UNIX_TIMESTAMP(date_create) as datec, UNIX_TIMESTAMP(tms) as tms";
